...
$sql =  "insert into $subject (year, title, letter, number, topic, question, answer, choice1, choice2, choice3) values($year, '$title', '$letter', $number, '$topic', '$question', '$answer', '$choice1', '$choice2', '$choice3');";
